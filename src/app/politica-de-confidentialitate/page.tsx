  ...
  return (
    <Container className="py-2">
      ...
      <div className="mt-4 max-w-2xl space-y-4 text-body">
        ...
        <p>Mersul Trenurilor Azi este un serviciu informativ independent pentru călătorii feroviare în România, disponibil la adresa <strong>mersultrenurilorazi.ro</strong>. Nu suntem afiliat oficial cu CFR Călători sau Infofer.</p>
