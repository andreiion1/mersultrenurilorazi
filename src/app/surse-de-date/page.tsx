  ...
  return (
    <Container className="py-2">
      ...
      <div className="mt-4 max-w-2xl space-y-4 text-body">
        ...
        <p>Orarul (rute, opriri, ore, zile de circulație) provine din seturile de date deschise <strong>„Mers tren"</strong> publicate pe portalul guvernamental <a className="text-primary hover:underline" href="https://data.gov.ro/organization/sc-informatica-feroviara-sa" target="_blank" rel="noopener noreferrer">data.gov.ro</a> de către Informatică Feroviară și operatorii feroviari (CFR Călători și ceilalți operatori licențiați).</p>
        <p>Aceste seturi sunt publicate sub licența <a className="text-primary hover:underline" href="https://creativecommons.org/licenses/by/4.0/deed.ro" target="_blank" rel="noopener noreferrer">Creative Commons Atribuire 4.0 Internațional (CC BY 4.0)</a>. Datele afișate pe acest site sunt <strong>prelucrate și adaptate de noi</strong> (reformatare, calcul de durate și estimări, geolocalizare a gărilor) pornind de la aceste seturi oficiale. Drepturile asupra datelor originale aparțin emitenților; îndeplinim condiția de atribuire indicând sursa, licența și faptul că am efectuat modificări.</p>
